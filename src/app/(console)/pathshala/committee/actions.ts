...
import { all, bool, FormError, int, isoDate, must, oneOf, reqStr, runAction, str } from "@/lib/forms";
...
export async function createAction(fd: FormData): Promise<ActionResult<unknown>> {
  return runAction("committee.createAction", "create the action", async () => {
    ...
    if (!can(viewer.access, "events.manage") && !(values.event_id && hasScopedRole(viewer.access, values.event_id, "event_lead"))) {
...
export async function updateAction(actionId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function setActionState(actionId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function addStatusUpdate(actionId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function deleteAction(actionId: string, fd: FormData): Promise<ActionResult<unknown>> {
  void fd;
 ...
 */
export async function pushActionToTemplate(actionId: string, fd: FormData): Promise<ActionResult<unknown>> {
  void fd;
...
// Templates
// ---------------------------------------------------------------------------
export async function saveTemplate(templateId: string | null, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function saveTemplateItem(templateId: string, itemId: string | null, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function deleteTemplateItem(itemId: string, fd: FormData): Promise<ActionResult<unknown>> {
  void fd;
...
export async function addLesson(target: { table: "event_templates" | "events"; id: string }, fd: FormData): Promise<ActionResult<unknown>> {
  return runAction("committee.addLesson", "save the lesson", async () => {
    const { supabase, viewer } = await actionContext();
    if (target.table === "event_templates" && !can(viewer.access, "events.manage")) throw new FormError("Only committee members who manage events can change templates.");
...
export async function removeLesson(target: { table: "event_templates" | "events"; id: string }, lessonId: string, fd: FormData): Promise<ActionResult<unknown>> {
  void fd;
...
export async function pushLessonsToTemplate(eventId: string, fd: FormData): Promise<ActionResult<unknown>> {
  void fd;
...
// ---------------------------------------------------------------------------
export async function createYear(fd: FormData): Promise<ActionResult<unknown>> {
...
export async function createConcern(fd: FormData): Promise<ActionResult<unknown>> {
...
export async function updateConcern(concernId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function createActionFromConcern(concernId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function saveResolution(resolutionId: string | null, fd: FormData): Promise<ActionResult<unknown>> {
  return runAction("committee.saveResolution", "save the resolution", async () => {
    ...
    if (resolutionId) {
      ...
      if (cur?.voting_status === "completed" && !viewer.access.isPlatformAdmin) throw new FormError("Voting has closed; only the outcome note can change now.");
...
export async function setPeriod(resolutionId: string, kind: "comment" | "voting", fd: FormData): Promise<ActionResult<unknown>> {
...
export async function addComment(resolutionId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function editComment(commentId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function castVote(resolutionId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function saveOutcome(resolutionId: string, fd: FormData): Promise<ActionResult<unknown>> {
...
export async function setWithdrawn(resolutionId: string, fd: FormData): Promise<ActionResult<unknown>> {
  return runAction("committee.setWithdrawn", "update the resolution", async () => {
    ...
    if (!withdraw && !can(viewer.access, "settings.manage")) throw new FormError("Only a center admin can restore a withdrawn resolution.");
    must(
      await supabase
        .from("resolutions")
